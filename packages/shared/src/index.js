    ...
    pipeline: [
        {
            name: "Prompt memory",
            status: "Ready",
            description: "Retrieve prior shots, styles, captions, and notes before generation."
        },
        {
            name: "Image draft",
            status: "Ready",
            description: "Generate a clean still image in FLUX.1-dev GGUF Q5_K_S or Q6_K."
        },
        {
            name: "Video finish",
            status: "Queued",
            description: "Animate through Wan 2.2 5B, then interpolate and upscale."
        }
    ],
    workflow: [
        {
    ...
    capabilities: [
        {
            ...
            description: "Store prompts, references, and winning parameter sets per project."
        },
        {
            title: "Workflow presets",
            description: "Switch between still, teaser, moodboard, and product ad pipelines."
        },
        {
            title: "Comfy orchestration",
            description: "Drive local or cluster ComfyUI jobs through a typed backend layer."
        },
        {
            title: "Assistant layer",
            description: "Make MCP-ready decisions for prompt refinement and workflow control."
        }
    ]
};
export const modelRecommendations = [
    {
        ...
        summary: "Best default image model for your setup due to prompt fidelity, text rendering, and reliable GGUF memory savings on Volta.",
        tags: ["Q5_K_S", "PyTorch SDP", "FluxGuidance 3.5-5.0"]
    },
    {
        name: "Wan 2.2 5B",
        role: "Video foundation",
        summary: "Best production video choice on V100 32GB because FP16 fits comfortably and the ecosystem already supports TeaCache, offloading, and post chains.",
        tags: ["FP16", "TeaCache", "RIFE + SeedVR2"]
    },
    {
        name: "LTX-2",
        role: "Secondary research path",
        summary: "Useful for experimentation, but not the first production target because memory pressure and loader complexity are less favorable on your hardware.",
